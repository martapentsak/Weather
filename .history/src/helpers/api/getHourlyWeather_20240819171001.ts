...
export const getHourlyWeather = async (location: Location) => {
  ...
  try {
    const URL = `https://api.open-meteo.com/v1/forecast?latitude=${location.latitude}52.52&longitude=13.41&hourly=temperature_2m,relative_humidity_2m,weather_code,surface_pressure,visibility,wind_speed_10m,wind_gusts_10m,uv_index&forecast_days=3`
