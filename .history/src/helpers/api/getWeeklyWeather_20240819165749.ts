...
export const getWeeklyWeather = async (location: Location) => {
  ...
  try {
    const URL = `https://api.open-meteo.com/v1/forecast?latitude=52.52&longitude=13.41&hourly=uv_index&daily=weather_code,temperature_2m_max,apparent_temperature_max&timezone=GMT&forecast_hours=1`
